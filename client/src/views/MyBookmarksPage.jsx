      ...
      {loading === false ? (
        <div className="mt-20 mb-28">
          ...
          <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
            Kamu sudah berhasil menambahkan {bookmarks.length} kos pilihan kamu
            ke daftar favorit, klik untuk melakukan booking kamar.
          </p>
        ...
        <div
          role="status"
          class="p-4 max-w-sm rounded border border-gray-200 shadow animate-pulse md:p-6 dark:border-gray-700 mt-20"
        >
