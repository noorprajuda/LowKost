            ...
            <h2 className="font-bold text-left text-4xl mb-10">
              ...
              <div className="flex flex-row justify-between">
                ...
                <button
                  ...
                  class="text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
